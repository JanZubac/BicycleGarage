...
/**
 * This class simulates a pin code terminal. It can be used when
 * BicycleGarageManager is tested.
 * 
 * @version 1.0
 * @author Martin H�st
 */
public class PinCodeTerminalTestDriver implements PinCodeTerminal,
	 ...
	 * 
	 * @param colour
	 *            PinCodeTerminal.RED_LED or PinCodeTerminal.GREEN_LED
	 * @param lightTime
	 *            Turn on LED for lightTime seconds
	 */
